...
To set up your data plane on Google Cloud Platform (GCP) you must allow Union Cloud to provision and maintain compute resources under your GCP account.
...
4. For **AWS Account ID**, enter `479331373192` (Union Cloud's management account ID)
